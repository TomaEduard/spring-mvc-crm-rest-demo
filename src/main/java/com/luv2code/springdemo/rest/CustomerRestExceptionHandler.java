...
public class CustomerRestExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<CustomerErrorResponse> handlException(CustomerNotFoundException e) {
	...
	@ExceptionHandler
	public ResponseEntity<CustomerErrorResponse> handlException(Exception e) {
